...
urlpatterns = [
    ...
    path(route="djangoapp/dealer/<int:dealer_id>/", view=views.get_dealer_details, name='dealer_details')
    path('djangoapp/dealer/<int:id>/add_review', view=views.add_review, name='add_review'),
